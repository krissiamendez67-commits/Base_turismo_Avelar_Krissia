...
Mostrando 1accommodation_database_restore ORIGINAL.sql
...
values (
	'Roberto', 'Magaña', 'Industries Diversas S.A de C.V',
	'robrMaga@gmail.com', '708-101-4572x0265', 'M-45870216',
...
'4', '3', '2', '205.35', 'USB', '15:00:00','12:00:00', 'F', '2026-04-17 01:23:25.356266',
'2026-04-17 01:23:25.356266');

SELECT * FROM accommodations

-- 3 INSERT Insetar Huesped y Reserva

insert into booking_guests (booking_guest_id, booking_id, first_name, last_name, age,
	document_number, created_at)
values ('104', '87', 'Daniel', 'Perez',
null, null,  '2026-04-15 01:23:25.356206');

SELECT * FROM booking_guests

-- 4 INSERT Insertar Pago
...
values ('101', '100', '8', null, '4', '2026-03-26', '2026-03-31', '3', '0', '817.49',
	'98.10', '5.08', '910.51', null, 'BK-OQ0IQ2RS', '2026-04-15 01:23:25.356206',
	'2026-04-15  01:23:25.356206', '26-04-15 01:23:25.356206');
...
select 
	...
	b.type_name					as tipo,
	a.base_price_per_night		as precio_nombre,
...
inner join payments as p	   on p.booking_id = a.accommodation_id
...
-- 19 HAVING Mas de Tres Reservas
SELECT
    a.accommodation_id,
    a.name                  AS alojamiento,
    COUNT(b.booking_id)     AS total_reservas
